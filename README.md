...
To train and evaluate the random forest models, use `run_through_trained_RF_models.ipynb`. The hyperparameter tuning results are generated by running `python hp_search_random_forest.py experiment_configs/tune_rf_12_channel.py` (or a different configuration file).
