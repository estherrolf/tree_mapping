...
- existing tree canopy height maps from the WRI and Meta [(hosted on AWS)](https://registry.opendata.aws/dataforgood-fb-forests/) -- or use 1acquire_data/download_meta_tiles.py1 
