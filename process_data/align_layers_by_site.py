...
sentinel_dirs = ['none',
                 '/n/home10/erolf/tree_mapping/data/raw/sentinel/S2A_MSIL2A_20230418T073611_R092_T36KVU_20230419T022704',
                 '/n/home10/erolf/tree_mapping/data/raw/sentinel/S2B_MSIL2A_20230413T073619_R092_T36KUU_20230413T131907',
                 '/n/home10/erolf/tree_mapping/data/raw/sentinel/S2A_MSIL2A_20230418T073611_R092_T36JUT_20230419T022652'
                ]
...
def process_sentinel_to_Karingani_data(chm_dir, chunked_sentinel_dir, buffer=40):
    ...
    for target_fn in target_fns:
        ...
        for s2_fn in list(os.listdir(sentinel_dir)):
            ...
            target_fp = os.path.join(chm_dir,target_fn)
