...
#SBATCH -p sapphire
#SBATCH -t 100         # Runtime in D-HH:MM:SS, minimum of 10 minutes
#SBATCH --mem 10G          # Memory pool for all cores (see also --mem-per-cpu) MBs
...
python train_nn_with_subsetted_train_sites.py ${1} ${2} ${3} ${4}